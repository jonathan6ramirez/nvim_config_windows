...
-- align cursor in the middle when moving half a page
...
-- vim.api.nvim_set_hl(0, 'WarningMsg', { bg = '#1e1e2e', fg = '#cdd6f4' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = 'Harpoon/LazyGit' },
        { '<leader>n', group = 'Highlihts' },
        { '<leader>x', group = 'TODO (Trouble)' },
      },
    },
  },
  ...
  --           highlights[group] = { italic = true, fg = '#c099ff' }
  --         end
  --       end,
  --
